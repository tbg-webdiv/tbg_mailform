...
<div id="mainwrap">
    ...
    <h1>LEDスマートリモコン ダウンロード</h1>
        ...
        <!-- END of GeoTrust Smart Icon tag -->
            <h2 class="dl">
                ...
                <ol class="dl_list">
                    <li>
                        <span>1</span>
                            <span>下記の項目にお答えください。（※印は必須項目です）</span>
                    </li>
                    <li>
                        <span>2</span>
                            <span>確認ボタンをクリックすると確認ページへ進みます。</span>
                    </li>
                    <li>
                        <span>3</span>
                            <span>内容を確認し間違いがなければ、「送信」ボタンをクリックします。</span>
                    </li>
                    <li>
                        <span>4</span>
                            <span>アンケート送信完了の画面が開き、「ダウンロード」ボタンが表示されます。</span>
                    </li>
                    <li>
                        <span>5</span>
                            <span>「ダウンロード」ボタンを選択すると、ダウンロードが開始されます。（任意の場所に保存してください）</span>
                    </li>
                    <li>
                        <span>6</span>
                            <span>ダウンロードされたファイルを選択し、「LEDスマートリモコン」のインストールを行います。</span>
                    </li>
                </ol>
        ...
        <h2 class="que_tit">
            <img decoding="async" src="/entry/wp-content/themes/tbg_mailform/assets/img/enq2.png" alt="">
                <span>アンケートにご協力ください</span>
        </h2>
        <div class="dl_main">
            <section class="col">
            ...
            <section class="col">
                ...
                <span>
                    ...
                    <span>
                        <div class="valid_message">　その他を選択された場合、ご入力ください。
                        </div>
                ...
                <h3>製造番号<span class="style3">※</span></h3>
                    <span>
                        <input type="text" name="serial" id="serial" class="serial" size="20" value="">
                            <span class="style2">（半角英数字）</span>
                            <div class="valid_message">　LED表示機本体の保証書に記載されている8桁の番号をご記入ください。</div>
                    </span>
            </section>
            <section class="col">
                <h3>購入販売社店名<span class="style3">※</span></h3>
                    <span>
                        <input type="text" name="shop" id="shop" class="shop" size="20" value="">
                            <span class="style2">（全角）</span>
                                <div class="valid_message">　製品を購入された販売社店名をご入力ください。</div>
                    </span>
            </section>
            <section class="col">
                ...
                <span>
                    ...
                    <span>
                        <select name="date_3" id="date_3" class="date_3">
                            ...
                            <span>日</span>
                                <div class="valid_message">　製品を購入された日付をご入力ください。</div>
                    </span>
                </span>
            </section>
            <section class="col">
            ...
            <section class="col">
                ...
                <span>
                    ...
                    <div class="valid_message">　ソフトのバージョンアップ等のご案内をお送り致します。
                    </div>
                </span>
            </section>
            <section class="col">
